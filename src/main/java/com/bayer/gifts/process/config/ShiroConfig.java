...
import com.bayer.gifts.process.sys.auth2.OAuth2Filter;
import com.bayer.gifts.process.sys.auth2.OAuth2Realm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/bayer/**", "anon");
        filterMap.put("/background/**", "anon");
