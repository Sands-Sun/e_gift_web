...
public interface GiftsGroupDao extends BaseMapper<GiftsGroupEntity> {
    ...
    void deleteUserToGroupByGroupId(Long groupId);

    void logicToDeleteUserToGroupByGroupId(Long groupId);

    List<GiftsUserToGroupEntity> queryUserToGroupList(Collection<Long> groupIds);
